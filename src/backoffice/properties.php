...
<div class="sidebar">
    ...
    <tr>
        ...
        <td>Île-de-France</td>
        <td>
            <svg class="infoIcon" data-popup-content="Détails concernant cette propriété..." xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="width: 40px; height: 40px; display: block; margin: 0 auto;">
            ...
            <div class="popup">
                <div class="popup-content">
                    ...
                    <p>Détails concernant cette propriété...</p>
                </div>
            </div>
        </td>
        <td>
            <svg class="manageIcon" data-popup-content="Options pour gérer cette propriété..." xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="width: 40px; height: 40px; display: block; margin: 0 auto;">
            ...
            <div class="popup">
                <div class="popup-content">
                    <span class="close">X</span>
                    <h3>Gestion de la propriété</h3>
                    <p>Options pour gérer cette propriété...</p>
                </div>
            </div>
        </td>
    </tr>
